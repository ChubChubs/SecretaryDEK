...
urlpatterns = [
    ...
    url(r'^students/(?P<id>[0-9]+)', api.StudentUpd.as_view()),
    url(r'^students', api.StudentView.as_view()),
    url(r'^chiefs/(?P<id>[0-9]+)', api.ChiefUpd.as_view()),
    url(r'^chiefs', api.StudentView.as_view()),
    url(r'^groups/(?P<id>[0-9]+)', api.GroupUpd.as_view()),
    url(r'^groups', api.GroupView.as_view()),
